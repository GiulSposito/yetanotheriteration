...
```{r readingTCX, warning=FALSE, message=FALSE, cache=TRUE}
# setup
library(XML)
library(lubridate)
library(tidyverse)
...
```{r mapBackground, warning=FALSE, message=FALSE, cache=TRUE}
library(ggmap)
...
```{r plotOverMap, warning=FALSE, message=FALSE, cache=TRUE}
