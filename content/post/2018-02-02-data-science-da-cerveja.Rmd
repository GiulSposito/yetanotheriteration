...
Neste post vamos extraír via _data scraping_ textos e dados de um blog de avaliações de cerveja para encontrar os termos que melhor caracterizam e descrevem os tipos de cerveja através das descrições do sabores da mesmas.
...
### Termos chaves para os tipos de servejas.
...
Podemos perceber que via _text mining_ conseguimos isolar os termos mais caracteríscos para cada tipo de cerveja. No próximo post vamos explorar as diferenças e semelhanças entre os divesos tipos e explorar a capacidade de fazer sugestões de cerveja de acordo com a características desejadas.
