...
The puzzle asks for *how many bags* can contain an `shiny_gold` bag, the answer is simple, we look the end of each possible path starting from node `shiny_gold` and count the unique bag types.
