...
tags:
  ...
  - forecast
  - simulation
coverImage: /images/fantasy_montecarlo_cover.jpg
metaAlignment: center
thumbnailImage: images/fantasy_montecarlo_tn.jpg
...
resp <- readRDS("./cache/league_matchups.rds")
```
...
rosters.json <- readRDS("./cache/rosters_json.rds")
```
...
players.points <- readRDS("./cache/players_points.rds") %>% 
...
```{r echo=FALSE}
players.ids <- readRDS("./cache/nfl_players_id.rds")
```
